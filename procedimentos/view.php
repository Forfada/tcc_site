...
<section class="procedimentos section-light section-cor3 py-5" id="procedimentos">
   <h5><?php echo $proc['p_nome']; ?></h5>
    <div class="col-12 col-md-7 text-md-end mt-2 mt-md-0">
        <a class="buttonc" href="<?php echo BASEURL; ?>procedimentos/edit.php?id=<?php echo $proc['id'];  ?>" style="text-decoration: none;"><i class="fa fa-plus"></i> Editar Procedimento</a>
