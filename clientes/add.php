                ...
                <div class="row justify-content-center">
                    <div class="col-md-5 d-flex justify-content-center gap-2 form">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control text-center" id="cli_nome" name="cli[cli_nome]" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 d-flex justify-content-center gap-2 form">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control text-center" id="cli_cpf" name="cli[cli_cpf]" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="cli_num">Número de Telefone</label>
                            <input type="tel" class="form-control text-center" id="cli_num" name="cli[cli_num]" required>
                        </div>
                    </div>
                </div>
