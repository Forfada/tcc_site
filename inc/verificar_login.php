...
<div class="verification-container">
    <div class="verification-card">
        ...
        <p>Enviamos um código para <strong><?php echo htmlspecialchars($login['email']); ?></strong>. Digite-o abaixo para concluir o acesso. Caso não tenha recebido, verifique sua caixa de spam.</p>
