<!-- Modal -->
<div class="modal fade" id="delete-proc-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-card-custom">
            <div class="modal-body text-center">
                <h3 class="modal-title-custom">Excluir Procedimento</h3>
                <p class="modal-text">Deseja realmente excluir este Procedimento? Esta ação não pode ser desfeita.</p>

                <div class="modal-actions">
                    <a type="button" class="buttonc" id="confirm" href="#">
